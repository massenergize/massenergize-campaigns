...
const Events = ({ campaignDetails, setCampaignDetails, setStep, lists,originalCampaignDetails }) => {
	const {
		allPartners,
		allManagers,
		allTechnologies,
	...
	return (
		...
		<CampaignEventsView events={allEvents} campaign={originalCampaignDetails} />
		// </m.div>
	);
};
