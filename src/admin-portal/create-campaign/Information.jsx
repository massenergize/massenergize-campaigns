		...
		try {
			...
			const payload = {
				...
				...(imageExists("primary_logo")
					? {}
					: { primary_logo: campaignDetails.primary_logo }),
				...(imageExists("secondary_logo")
					? {}
					: { secondary_logo: campaignDetails.secondary_logo }),
				...(imageExists("campaign_image")
					? {}
					: typeof campaignDetails?.campaign_image !== "undefined"
					? { campaign_image: campaignDetails.campaign_image }
					: {}),
			};
