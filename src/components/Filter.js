  ...
  return (
    <div>
      <div>
        <NavDropdown
          title={
            <span style={{ fontWeight: "bold", color: "var(--theme-main-color)" }}>
        ...
        >
          {filterOptions?.map((item) => {
            ...
            return (
              ...
              >
                {getLabel(item)}
                {isChecked && <i className="fa fa-check" style={{ marginLeft: 6, color: "var(--theme-main-color)" }} />}
              </NavDropdown.Item>
            );
          })}
        </NavDropdown>
            ...
            return (
              <span
                ...
                style={{
                  ...
                  border: "dashed 1px var(--theme-main-color)",
                  borderRadius: 55,
                  padding: "4px 15px",
                  margin: 5,
                }}
